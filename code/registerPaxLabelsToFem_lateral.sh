...
export in_mask='../intermediateFiles/paxLabelsAlignedToOsparcMask_lateral.nii.gz' # Mask of osparc rat, from eval.py
export in_mask_binary='../intermediateFiles/paxLabelsAlignedToOsparcMask.nii.gz' # Mask of osparc rat, from eval.py

export ref_mask='../intermediateFiles/PWMaskMask_v6.nii.gz' # Mask of paxinos-watson atlas, from eval.py
...
export transform_osparc_to_pw_final='../intermediateFiles/pwMatrix_final_v6.mat' # FSL transformation matrix that aligns osparc rat to paxinos-watson atlas

export unused_output_image='../intermediateFiles/pwOutput.nii.gz'

python eval_testLateral.py #$SLURM_ARRAY_TASK_ID
