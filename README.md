...
11. 
12. The script transformFullMeshBig.sh then loads the oSparc  rat head (data/Crop-20210802.nii.gz),  the padded Paxinos-Watson image, and aligns the former to the latter using the ANTs transform generated by transformFullMeshBig.py. This step also applies a scaling of 0.92 in order to match the juvenile rat.
