...
matrix = np.loadtxt('../intermediateFiles/pwMatrix_final_v6.mat')#FSL Transformation matrix aligning osparc to paxinos-watson atlas, produced by registerPaxLabelsToFem.sh
...
ants.write_transform(t,'../intermediateFiles/transformFullMesh_v6.mat') #ANTs Transformation matrix aligning osparc to paxinos-watson atlas
