...
export transform='../intermediateFiles/transformFullMesh_v6.mat' # ANTs transformation matrix to align osparc to paxinos-watson atlas. Produced by transformFullMesh.py

export output='alignedModel_v6.nii.gz'
 

python transformFullMeshBig_lateral.py $SLURM_ARRAY_TASK_ID
