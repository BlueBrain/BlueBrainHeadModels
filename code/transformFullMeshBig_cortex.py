...
matrix = np.loadtxt('../intermediateFiles/pwMatrix_Ctx.mat')#FSL Transformation matrix aligning osparc to paxinos-watson atlas, produced by registerPaxLabelsToFem.sh
...
ants.write_transform(t,'../intermediateFiles/transformFullMesh_ctx.mat') #ANTs Transformation matrix aligning osparc to paxinos-watson atlas
