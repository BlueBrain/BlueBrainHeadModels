...
matrix = np.loadtxt('../intermediateFiles/pwMatrix_final.mat')#FSL Transformation matrix aligning osparc to paxinos-watson atlas, produced by registerPaxLabelsToFem.sh
