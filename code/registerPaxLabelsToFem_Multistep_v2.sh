...
export ref_mask='../intermediateFiles/PWMaskMask_v'$SLURM_ARRAY_TASK_ID'.nii.gz' # Mask of paxinos-watson atlas, from eval.py
...
export transform_osparc_to_pw_final='../intermediateFiles/pwMatrix_final_v'$SLURM_ARRAY_TASK_ID'.mat' # FSL transformation matrix that aligns osparc rat to paxinos-watson atlas

export unused_output_image='../intermediateFiles/pwOutput.nii.gz'

python eval_v2.py $SLURM_ARRAY_TASK_ID
